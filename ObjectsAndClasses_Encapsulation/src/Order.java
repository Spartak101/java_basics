...
/*    public Order() {
    ...
    public Order(int mass, String deliveryAddress, boolean flipOver, String registrationNumber, boolean fragile) {
        this.mass = mass;
    ...
    public Order setMass(int mass) {
        ...
        return new Order(mass2, deliveryAddress, flipOver, registrationNumber, fragile);
    }
    ...
    public Order setDeliveryAddress(String deliveryAddress) {
        ...
        return new Order(mass, deliveryAddress2, flipOver, registrationNumber, fragile);
    }
    ...
    public Order setFlipOver(boolean flipOver) {
        ...
        return new Order(mass, deliveryAddress, flipOver2, registrationNumber, fragile);
    }
    ...
    public Order setRegistrationNumber(String registrationNumber) {
        ...
        return new Order(mass, deliveryAddress, flipOver, registrationNumber2, fragile);
    }
    ...
    public Order setFragile(boolean fragile) {
        ...
        return new Order(mass, deliveryAddress, flipOver, registrationNumber, fragile2);
    }
